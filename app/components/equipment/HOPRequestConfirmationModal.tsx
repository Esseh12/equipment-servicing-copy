...
interface HOPRequestConfirmationModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  requestData: any;
...
export function HOPRequestConfirmationModal({ isOpen, onClose, onConfirm, requestData }: HOPRequestConfirmationModalProps) {
...
// Interactive version of the modal
      ...
      <div className="content-stretch flex flex-col items-center relative shrink-0 w-full">
        <div className="box-border content-stretch flex flex-col gap-[16px] items-start pb-0 pt-[24px] px-[24px] relative w-full">
          ...
          <div className="content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 w-full">
            ...
            <p className="font-['Inter:Medium',_sans-serif] font-medium leading-[20px] relative shrink-0 text-[#475467] text-[14px] w-full">Submit equipment servicing request for approval</p>
          </div>
        </div>
      </div>
      ...
      <div className="box-border content-stretch flex flex-col items-start pb-0 pt-[32px] px-0 relative shrink-0 w-full">
        <div className="box-border content-stretch flex gap-[12px] items-start pb-[24px] pt-0 px-[24px] relative w-full">
          ...
          >
            <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
              <div className="box-border content-stretch flex gap-[8px] items-center justify-center px-[18px] py-[10px] relative w-full">
                <p className="font-['Inter:Semi_Bold',_sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[16px] text-nowrap text-white whitespace-pre">Yes, Submit</p>
              </div>
            </div>
          </button>
        </div>
