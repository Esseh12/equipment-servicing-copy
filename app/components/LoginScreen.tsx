    ...
    <div className="min-h-screen bg-[#f8f9fa] flex items-center justify-center p-4">
      <div className="bg-white rounded-lg border border-[#e2e8f0] shadow-lg p-8 w-full max-w-md">
        ...
        <div className="space-y-3">
          ...
          >
            <div className="text-[14px] font-semibold">Login as CCO / Initiator</div>
            <div className="text-[11px] opacity-90">Customer Care Officer - Initiate LOI requests</div>
          </button>
          ...
          <button
            ...
            className="w-full bg-[#003883] hover:bg-[#002664] text-white p-4 rounded-lg transition-colors"
          >
            <div className="text-[14px] font-semibold">Login as Credit Operations</div>
            <div className="text-[11px] opacity-90">Process and validate customer balances</div>
          </button>
          ...
          >
            ...
            <div className="text-[11px] opacity-90">Review and approve LOI requests</div>
          </button>
        </div>
