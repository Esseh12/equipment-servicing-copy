...
import { Search, ChevronDown, Plus, Home, ChevronRight, FileText, Lock, Users, TrendingUp } from 'lucide-react';
...
interface EmptyStaffTransactionHistoryProps {
  onNewRequest: () => void;
  onBack: () => void;
  onAuditTrail?: () => void;
...
// Main Content
function MainContent({ onNewRequest, onBack, breadcrumbs, onBreadcrumbClick }: EmptyStaffTransactionHistoryProps) {
  return (
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6 lg:mb-8">
          <div className="flex flex-col gap-[4px]">
            ...
            <p className="font-['Inter:Regular',_sans-serif] font-normal text-[14px] lg:text-[16px] text-[#475467] leading-[20px] lg:leading-[24px]">
              Process and manage KPA payment collections for customers
            </p>
          </div>
        ...
        <div className="bg-white rounded-[12px] border border-[#eaecf0] shadow-[0px_1px_3px_0px_rgba(16,24,40,0.1),0px_1px_2px_0px_rgba(16,24,40,0.06)] min-h-[400px] flex flex-col items-center justify-center p-8 lg:p-16">
          <div className="text-center max-w-md mx-auto">
            ...
            <p className="font-['Inter:Regular',_sans-serif] font-normal text-[14px] lg:text-[16px] text-[#475467] leading-[20px] lg:leading-[24px] mb-8">
              Start by processing your first KPA collection request to see the transaction history here.
            </p>
...
export function EmptyStaffTransactionHistory({ onNewRequest, onBack, onAuditTrail, breadcrumbs, onBreadcrumbClick }: EmptyStaffTransactionHistoryProps) {
  return (
