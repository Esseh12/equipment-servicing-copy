import svgPaths from "./svg-d3yjj36nir";
...
function TextAndSupportingText() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 w-full" data-name="Text and supporting text">
      ...
      <p className="font-['Inter:Medium',_sans-serif] font-medium leading-[20px] relative shrink-0 text-[#475467] text-[14px] w-full">Submit Request for letter of indebtness</p>
    </div>
  );
}
